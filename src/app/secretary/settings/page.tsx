...
export default async function SecretarySettingsPage() {
  ...
  return (
    <div>
      <h1 className="mb-1 text-lg font-medium text-neutral-900">Settings</h1>
      <p className="mb-6 text-sm text-neutral-500">Manage doctor one-off closures and blocked dates.</p>
      <ScheduleManager
        doctors={doctors ?? []}
        initialWorkingHours={[]}
