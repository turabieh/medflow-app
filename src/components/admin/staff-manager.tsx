...
function StaffRow({member,editing,onEdit,onSave,onToggle}:{member:StaffMember;editing:boolean;onEdit:()=>void;onSave:(d:{fullName:string;role:string;specialty?:string})=>Promise<void>;onToggle:()=>void;}) {
